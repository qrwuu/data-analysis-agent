...
def generate(
    ...
    **kwargs
    ...
    try:
        ...
        waterfall_colors = {
            "increase": scheme.get("positive", "#22C55E"),
            "decrease": scheme.get("negative", "#EF4444"),
            "total": scheme.get("primary", "#6366F1"),
        }
        ...
        fig = go.Figure(go.Waterfall(
            ...
            cliponaxis=False,
            increasing=dict(marker=dict(color=waterfall_colors["increase"], line=dict(color="white", width=1))),
            decreasing=dict(marker=dict(color=waterfall_colors["decrease"], line=dict(color="white", width=1))),
            totals=dict(marker=dict(color=waterfall_colors["total"], line=dict(color="white", width=1))),
