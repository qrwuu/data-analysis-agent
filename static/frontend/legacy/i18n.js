...
(function () {
  const T = {
    zh: {
      ...
      'welcome.desc': '连接数据库或上传 Excel，用自然语言提问，AI 会自动查询、分析并生成图表。<br>直接描述想分析的问题即可。',
      // ── Input ────────────────────────────────────────────────────
      ...
      'modal.excel.hint': '支持 .xlsx / .xls / .csv，本次最多 5 个，建议每个文件不超过 20MB',
      // ── DB modal ─────────────────────────────────────────────────
    ...
    en: {
      ...
      'welcome.desc': 'Connect a database or upload Excel, ask in natural language, and AI will query, analyze, and generate charts.<br>Describe the analysis you need directly.',
      // ── Input ────────────────────────────────────────────────────
      ...
      'modal.excel.hint': 'Supports .xlsx / .xls / .csv, up to 5 files per upload, recommended under 20 MB each',
      // ── DB modal ─────────────────────────────────────────────────
